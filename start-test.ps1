...
$DllPath = Join-Path $DllPath "MessageBox.dll"


Write-Host "=========================================================" -f DarkYellow
Write-Host " Register-MessageBoxDll -- Registering Controls...`n" -f DarkRed
...
try{
  Register-MessageBoxDll Release
  Get-ProcessUsingModule "MessageBox.dll"
}catch{
  Write-Error "$_"
}
